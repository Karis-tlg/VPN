 ...
 *  net.minecraft.server.v1_14_R1.Containers
 ...
 *  net.minecraft.server.v1_14_R1.ICrafting
 *  net.minecraft.server.v1_14_R1.IInventory
 *  net.minecraft.server.v1_14_R1.Packet
 *  net.minecraft.server.v1_14_R1.PacketPlayOutCloseWindow
 *  net.minecraft.server.v1_14_R1.PacketPlayOutExperience
 *  net.minecraft.server.v1_14_R1.PacketPlayOutOpenWindow
 ...
 *  org.bukkit.craftbukkit.v1_14_R1.event.CraftEventFactory
...
implements VersionWrapper {
    ...
    public VersionWrapper.AnvilContainerWrapper newContainerAnvil(Player player, Object guiTitle) {
        if (this.IS_ONE_FOURTEEN) {
            return new AnvilContainer1_14_4_R1(player, this.getRealNextContainerId(player), (IChatBaseComponent)guiTitle);
        }
    ...
    implements VersionWrapper.AnvilContainerWrapper {
        public AnvilContainer(Player player, IChatBaseComponent guiTitle) {
            super(Wrapper1_14_R1.this.getRealNextContainerId(player), ((CraftPlayer)player).getHandle().inventory, ContainerAccess.at((World)((CraftWorld)player.getWorld()).getHandle(), (BlockPosition)new BlockPosition(0, 0, 0)));
