...
public final class Wrapper1_20_R3
implements VersionWrapper {
    ...
    implements VersionWrapper.AnvilContainerWrapper {
        public AnvilContainer(Player player, int containerId, IChatBaseComponent guiTitle) {
            super(containerId, ((CraftPlayer)player).getHandle().fS(), ContainerAccess.a((World)((CraftWorld)player.getWorld()).getHandle(), (BlockPosition)new BlockPosition(0, 0, 0)));
        ...
        public void setRenameText(String text) {
            ...
            if (inputLeft.f()) {
                inputLeft.g().a((IChatBaseComponent)IChatBaseComponent.b((String)text));
            }
        }
