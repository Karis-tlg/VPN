 ...
 *  net.minecraft.server.v1_16_R1.ContainerAccess
 *  net.minecraft.server.v1_16_R1.ContainerAnvil
 *  net.minecraft.server.v1_16_R1.Containers
 ...
 *  net.minecraft.server.v1_16_R1.ICrafting
 *  net.minecraft.server.v1_16_R1.IInventory
 *  net.minecraft.server.v1_16_R1.Packet
 *  net.minecraft.server.v1_16_R1.PacketPlayOutCloseWindow
 *  net.minecraft.server.v1_16_R1.PacketPlayOutExperience
 *  net.minecraft.server.v1_16_R1.PacketPlayOutOpenWindow
 *  net.minecraft.server.v1_16_R1.Slot
 *  net.minecraft.server.v1_16_R1.World
 *  org.bukkit.craftbukkit.v1_16_R1.CraftWorld
 *  org.bukkit.craftbukkit.v1_16_R1.entity.CraftPlayer
 *  org.bukkit.craftbukkit.v1_16_R1.event.CraftEventFactory
...
implements VersionWrapper {
    ...
    implements VersionWrapper.AnvilContainerWrapper {
        public AnvilContainer(Player player, IChatBaseComponent guiTitle) {
            super(Wrapper1_16_R1.this.getRealNextContainerId(player), ((CraftPlayer)player).getHandle().inventory, ContainerAccess.at((World)((CraftWorld)player.getWorld()).getHandle(), (BlockPosition)new BlockPosition(0, 0, 0)));
