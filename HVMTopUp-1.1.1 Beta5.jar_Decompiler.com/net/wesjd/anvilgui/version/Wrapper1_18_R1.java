 ...
 *  org.bukkit.craftbukkit.v1_18_R1.CraftWorld
 *  org.bukkit.craftbukkit.v1_18_R1.entity.CraftPlayer
 *  org.bukkit.craftbukkit.v1_18_R1.event.CraftEventFactory
...
public final class Wrapper1_18_R1
implements VersionWrapper {
    ...
    public void setActiveContainerDefault(Player player) {
        this.toNMS((Player)player).bW = this.toNMS((Player)player).bV;
    }

    @Override
    public void setActiveContainer(Player player, VersionWrapper.AnvilContainerWrapper container) {
        this.toNMS((Player)player).bW = (Container)container;
    }
    ...
    implements VersionWrapper.AnvilContainerWrapper {
        public AnvilContainer(Player player, int containerId, IChatBaseComponent guiTitle) {
            super(containerId, ((CraftPlayer)player).getHandle().fq(), ContainerAccess.a((World)((CraftWorld)player.getWorld()).getHandle(), (BlockPosition)new BlockPosition(0, 0, 0)));
        ...
        public void setRenameText(String text) {
            ...
            if (inputLeft.f()) {
                inputLeft.e().a((IChatBaseComponent)new ChatComponentText(text));
            }
        }
